/**
 * Stage 3: Citizen Complaint Submission & Evidence Upload Controller
 */
...
document.addEventListener('DOMContentLoaded', async () => {
  // Verify authenticated citizen session
...
async function loadCitizenCaseData() {
  try {
    ...
    if (res.success) {
      ...
      // Populate Form if details already exist
